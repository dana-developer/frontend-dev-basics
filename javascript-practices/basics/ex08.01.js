...
a2[0] = 0;
a2[1] = "hello";
a2[10] = {}; // 사이즈가 동적으로 변경된다. (처음 지정한 크기보다 늘어나도 에러가 발생X)
...
o6["1"] = 1;
o6["2"] = 2;
o6.length = 3; // 유사 배열 (a6.length로 따로 지정하면, 배열과 거의 동일하다)
o6.name = "둘리";
o6.age = 10;
console.log(o6[0], o6[1], o6[2], o6["name"], o6["age"], o6.length);
// 객체는 a6.length를 따로 설정해주지 않으면, undefined로 나온다.
// 배열은 a6.length가 자동으로 늘어난다.
